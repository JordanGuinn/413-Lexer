...
public class SourceReader {
    ...
    private String nextLine, contents;
...
*/
    public char read() throws IOException {
        if (isPriorEndLine) {
            ...
            contents += "\n" + lineno + ". " + nextLine;
            if (nextLine != null) {
                System.out.println(/* "READLINE:   "+ */lineno + ". " + nextLine);
            }
        ...
        char here = nextLine.charAt(position); 
        return here;
    }
 ...
 *  @return the last full line just read
*/
    public String getNextLine() {
        return nextLine;
    }/**

 *  @return the contents of the source program
*/
